Mega Project List | [thekarangoel](https://github.com/thekarangoel/Projects)
========

Numbers
---------

[**Find PI to the Nth Digit**](https://github.com/maxdeviant/projects-ruby/blob/master/Numbers/pi_nth.rb) - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.
...
[**Find Cost of Tile to Cover W x H Floor**](https://github.com/maxdeviant/projects-ruby/blob/master/Numbers/tile_cost.rb) - Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
[**Tax Calculator**](https://github.com/maxdeviant/projects-ruby/blob/master/Numbers/tax_calculator.rb) - Asks the user to enter a cost and either a country or state tax. It then returns the tax plus the total cost with tax.
...
[**Reverse a String**](https://github.com/maxdeviant/projects-ruby/blob/master/Text/reverse_string.rb) - Enter a string and the program will reverse it and print it out.

**Pig Latin** - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/maxdeviant/projects-ruby/blob/master/Text/count_vowels.rb) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/maxdeviant/projects-ruby/blob/master/Text/palindrome.rb) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
